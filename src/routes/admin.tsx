...
import { LayoutDashboard, TrendingUp, FileText, FolderKanban, Image, Users, Newspaper, FileEdit, Inbox, LogOut, KeyRound, Building2 } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/stock", label: "AKPL Price", icon: TrendingUp },
